...
public class BackActivity extends Activity {
    ...
    String[] country = {"AFN", "EUR", "USD", "AOA", "XCD", "ARS", "AMD", "AWG", "AUD", "AZN", "BSD", "BHD", "BDT", "BBD", "BYN", "BZD"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        convertFromDropdownTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fromDialog = new Dialog(BackActivity.this);
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<>(BackActivity.this, android.R.layout.simple_list_item_1, arrayList);
        ...
        convertToDropdownTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                toDialog = new Dialog(BackActivity.this);
        ...
        convertButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Double amountToConvert = Double.valueOf(BackActivity.this.amountToConvert.getText().toString());
    ...
    public String getConversionRate(String convertFrom, String convertTo, Double amountToConvert) {
        ...
        String url = "https://free.currconv.com/api/v7/convert?q=" + convertFrom + "_" + convertTo + "&compact=ultra&apiKey=506d99c1a554dc83d453";
